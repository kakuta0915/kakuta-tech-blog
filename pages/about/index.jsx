      ...
      <Container>
        <div className={styles.profile}>
          ...
          <p className={useScrollAnimationStyles.fadeInUp}>
            ...
            <br />
            私はこれまで介護施設や医療施設で働いてきましたが、この業界は人手不足や給与の低さなど、多くの課題を抱えています。そのため、この業界での長期的なキャリアに不安を感じるようになりました。
            <br />
            キャリアチェンジを模索する中で、SNSでエンジニアという職種を知り、興味を持ちました。独学でプログラミングを始めたところ、その楽しさや可能性に魅了され、エンジニアとしてキャリアを積みたいという思いが強まりました。
            <br />
            世の中には、業務の効率化や課題解決にIT技術が活かせる場面は多くあると感じています。こうした問題を解決し、社会に貢献できるエンジニアになりたいと考えています。
          </p>
